...
subtitle: In Fall of 2019, I lead a series of five workshops on data visualization. This page houses the handouts and materials for those workshops.
redirect_from: 
    - "/dataviz-workshops"
    - "/pages/dataviz"
    - "/pages/dataviz-workshops"
---

<br/>
<!-- These R-workshops is duplicated in pages/r-workshops -->

## [Part 1: Intro to ggplot2](/downloads/190821-intro_to_ggplot2.html)
...
## [Part 2: Extending your ggplot2 skills](/downloads/190828-ggplot2_intermediate.html)
...
### [Supplement to Part 2](/downloads/190828-ggplot2_supplement.html)
...
## [Custom Themes](/downloads/190904-ggplot2_custom_themes.html)

*September 4, 2019*--Based on a popular [blog post](/blog/custom-themes-in-ggplot2) I wrote, this workshop wraps all customization methods together and shows how to create your own themes.

### [Supplement to Part 3: A detailed look at `ggplot2::theme`](/downloads/190904-ggplot2_theme.html)
...
## [*Fidelity, integrity, and sophistication: Edward Tufte’s principles of data visualization*](/downloads/191016-Tufte.pdf)
