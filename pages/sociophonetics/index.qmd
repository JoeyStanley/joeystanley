...
As a supplement, you can look at [this tutorial](https://lingmethodshub.github.io/content/R/lvc_r/010_lvcr.html) by Michael Hunt Gardner. It overlaps with mine a bit, but it's nice to get a solid foundation. 
...
Learn the basics of plotting using ggplot2. This will be based on [Part 1](/downloads/190821-intro_to_ggplot2.html) and [Part 2](/downloads/190828-ggplot2_intermediate.html) (and [supplement](/downloads/190828-ggplot2_supplement.html)) of a previous workshop. There is a ton more that can be done with ggplot2, which will be covered in Series 4 below.
...
Learn how to work with vowel trajectories and the two main ways you can plot those. I have my own tutorial [here](/blog/making-vowel-plots-in-r-part-2/) and to some extent [here](https://joeystanley.com/blog/geomtextpath/). [This](https://lingmethodshub.github.io/content/R/animated_vowel_plots_tutorial/) is another good one by Joshua Wilson Black.
...
This tutorial shows you how to use DARLA to do transcription, forced-alignment, and formant extraction all at once. Unlike most tutorials here, this is done entirely through an online interface, so you won't need to know R or any other programming. [Edit: As of June 2026, DARLA is no longer working, so this won't be helpful anymore.]

### ~~[Whisper](/blog/whisper)~~

This tutorial shows you how to use Whisper to automatically transcribe your audio using AI right within R. For now, the tutorial is basic and is not suited for processing lots of files at once, but if you need to work with just a few files, this might be of use to you. [Edit: This R package is not longer functional, so this is not helpful anymore.]
...
Extract vowel formant measurements with [Fast Track](https://github.com/santiagobarreda/FastTrack). This is probably not necessary anymore because it's been folded into new-fave. 

### New-Fave

Extract vowel formant measurements using [new-fave](https://forced-alignment-and-vowel-extraction.github.io/new-fave/).

### VoxHumana

My own online program, [VoxHumana](https://stanley.byu.edu/VoxHumana/) handles transcription with Whisper, forced-alignment with MFA, and extracting formant measurements with new-fave. We'll work with this and see what it can do.
...
Learn to use DCT Coefficients when working with vowel formant trajectories with Joe Fruehwald's tutorials [here](https://jofrhwld.github.io/blog/posts/2024/07/2024-07-19_dct-r/) and [here](https://jofrhwld.github.io/blog/posts/2025/06/2025-06-17_dct-in-tidynorm/). This includes [regression](https://jofrhwld.github.io/blog/posts/2025/11/2025-11-13_how-and-when-to-do-a-functional-regression/)

### Pipeline

[Pipeline](https://stanley.byu.edu/pipeline) is another online tool that I have created that automatically codes allophones, detects outliers, normalizes, and processes things with a recommended order of operations. We'll work with this, see what it can do, and find ways to improve it. 


## Series 4: Data visualization

In this series, we'll just focus on making good plots. We'll look at aesthetics and what makes for a good plot. We'll also explore additional ways of visualizing data. A good general resource is Andrew Heiss's open [course](https://datavizf23.classes.andrewheiss.com) on Data Visualization.
...
There are lots of recent resources that can be helpful. Here are some I'd like to go through:

* Michael Gardner's suite of statistics tutorials on the Ling Methods Hub, starting with [this one](https://lingmethodshub.github.io/content/R/lvc_r/060_lvcr.html).
* See Stefano Coretta's post on [mixed effects](https://stefanocoretta.github.io/posts/2021-03-15-on-random-effects/). 
* Stafano Coretta's [Quantitative Data Analysis for Linguists in R](https://stefanocoretta.github.io/qdal/)

For Bayesian analysis, here are some tutorials I'd like to go through:

* [Bayesian Multivariate Linear Mixed Effects models in brms](https://osf.io/preprints/psyarxiv/7xjmh_v1)
* [Beta Regression with brms](https://www.sciencedirect.com/science/article/pii/S009544702500066X)