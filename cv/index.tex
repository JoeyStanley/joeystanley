...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, toprule=.15mm, bottomrule=.15mm, toptitle=1mm, colframe=quarto-callout-note-color-frame, breakable, opacitybacktitle=0.6, left=2mm, bottomtitle=1mm, opacityback=0, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, arc=.35mm, rightrule=.15mm, colback=white]
