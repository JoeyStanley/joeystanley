...
I've tried to keep as much of the original structure of the site the same as I could. However, as I migrated, I realized that I could make things overall a bit more contained by changing the structure of associated files. 
...
- Within each post, I needed to update the header. I change from "tags" to "categories", from "redirect_from" to "aliases." I add a date-modified if needed. I remove excerpts because I only used them with my "big-link" style button. I'm replacing big-links with a standard callout box. I haven't figured out if I can do re1directs-to, which is a bummer for the GSV.


It took from September 10 to November 27 to transfer all my blog posts. I tried to do one a day and there are 94 of them.


TODO
* Rename blog post folders to something shorter and more consistent. Put aliases to old ones and make sure they work. Make sure internal links work.

* Change any me-specific HTML, like <span class="sidenote"> and tables. Within sidenotes themselves, I had to do HTML rather than markdown.