...
Any kind of student-produced work would likely fall under this category, whether it be an undergraduate honor's thesis, a Master's thesis, and PhD dissertation, etc. There are six pieces of information you should note in your Zotero entry:

* **Title**: This is is the full title. If there is a subtitle, include that too, separated by a colon.
* **Author**: The student who produced the work.
* **Type**: This is where you specify what kind of thesis it is. I put things like "MA Thesis" or "PhD Dissertation" or whatever is most appropriate.
* **University**: The university or institution where the work was conducted.
* **Place**: The city where the university is located. For US-based institutions, I put the city and the state. For others, I put the city and the country. 
* **Date**: The year the thesis was produced. 

All of this information is usually displayed on the front page of the work, so it's not too bad to manually type it all in. 

### Other item types

Of course there are tons of other kinds of items in Zotero. Other common ones that I have include conference papers and software. I encourage you to look through those item types and see what kind of information you'd need. 
