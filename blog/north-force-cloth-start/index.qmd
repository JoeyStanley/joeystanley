...
<!--These tables are generated in the NWAV2025.Rmd script-->
|  |  |  |  |  |  |  |  |
|:-|-:|:-|-:|:-|-:|:-|-:|
...
**Definition**: The <sc>north</sc> set is defined as words that are /ɔː/ in British English but /ɔɹ/ in American English varieties that don't merge <sc>force</sc> and <sc>north</sc>. If the following sound is a vowel (as in *horrible*, *orange*), it belongs to <sc>cloth</sc>. 
...
:::{.callout-tip}
Here are all the <sc>cloth</sc> words in my [Kohler Tapes](/blog/kohler-tapes-update3/) corpus, with their frequency per million words. 
