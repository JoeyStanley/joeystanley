...
## Cereal ([.csv](cereal.csv) or [.txt](cereal.txt))
...
## [McDonald's Menu Items](menu.csv)
...
## [Missionary Voice](missionary_voice/index.qmd)
...
## [Top 25 Girl Names in 2017](girlnames.txt)
...
## Vowels ([tall](vowels_tall.csv) and [wide](vowels_wide.csv))
